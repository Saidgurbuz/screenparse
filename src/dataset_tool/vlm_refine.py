# -*- coding: utf-8 -*-
"""
VLM-driven UI element relabeling using Qwen3-VL via vLLM.

This module provides functionality to refine UI element labels using vision-language models.
It processes element crops and full-page screenshots to generate improved semantic labels
for UI elements based on visual and contextual information.
